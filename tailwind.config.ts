    ...
    extend: {
      ...
      colors: {
        ...
        'command': {
          ...
          'surface-elevated': 'hsl(var(--command-surface-elevated))',
          border: 'hsl(var(--command-border))',
          'border-bright': 'hsl(var(--command-border-bright))',
          accent: 'hsl(var(--command-accent))',
          'accent-muted': 'hsl(var(--command-accent-muted))',
          success: 'hsl(var(--command-success))',
          warning: 'hsl(var(--command-warning))',
          danger: 'hsl(var(--command-danger))',
          text: 'hsl(var(--command-text))',
          'text-muted': 'hsl(var(--command-text-muted))',
          'text-dim': 'hsl(var(--command-text-dim))',
        },
      },
      borderRadius: {
        lg: "var(--radius)",
